    ...
    <div class="rounded-2xl bg-white/5 border border-white/10 overflow-hidden">
      ...
      <div class="p-6">
        ...
        <div class="mb-8 flex flex-col sm:flex-row gap-3">
          ...
          <a href="{{ route('video.test') }}" class="px-6 py-3 rounded-xl bg-emerald-600 text-white hover:bg-emerald-700 text-sm font-medium transition-all flex items-center gap-2 justify-center">
